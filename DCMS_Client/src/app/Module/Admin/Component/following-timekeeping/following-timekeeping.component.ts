...
import { RequestBodyTimekeeping } from 'src/app/Module/Receptionist/Model/ITimekeeping';
import { TimeKeepingService } from '../../Service/TimekeepingService/timekeeping.service';
...
export class FollowingTimekeepingComponent implements OnInit {
  ...
  getFollowingTimekeeping() {
    ...
    console.log(endTime)
    this.timekeepingService.getFollowingTimekeeping(startTime, endTime).subscribe((data: any) => {
